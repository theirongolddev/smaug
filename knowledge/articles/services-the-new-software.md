...
source: "https://x.com/i/article/2029647344635969537"
author: "JulienBek"
tags: [ai-business-strategy, autopilot, services, sequoia, market-map, ai-companies]
via: "Twitter bookmark from @JulienBek"
---

A Sequoia Capital thesis arguing the next trillion-dollar companies will be AI-native services firms — "autopilots" that sell outcomes (close the books, draft the NDA) rather than tools (copilots). Framework: copilots sell tools to professionals; autopilots sell work to companies. Labor budgets are 6x larger than software budgets, so autopilots capture far more value. The wedge: start with tasks that are already outsourced (existing budget line, outcome-based buying, vendor swap not a reorg), intelligence-heavy, and have aging/fragmented workforces. Includes an opportunity map across 9 verticals totaling $1T+ in labor TAM.

## Key Takeaways
- Sell the work, not the tool — autopilots capture the labor budget, which is 6x larger than the software budget
- Best wedge: already outsourced + high intelligence ratio + aging workforce + fragmented distribution = frictionless vendor swap
- Copilot → autopilot transition creates innovator's dilemma for existing AI tool companies (cutting out their own customers)
- Intelligence work = autopilot wins today; judgement work = accumulate proprietary data → expand coverage over time
- Opportunity map: insurance brokerage ($140–200B), IT managed services ($100B+), supply chain ($200B+), recruitment ($200B+), accounting ($50–80B), healthcare revenue cycle ($50–80B), claims adjusting ($50–80B), legal transactional ($20–25B), tax advisory ($30–35B)
...
- [Article](https://x.com/i/article/2029647344635969537)
- [Original Tweet](https://x.com/JulienBek/status/2029680516568600933)
