...
author: "hooeem"
tags: ["automation", "life-audit", "productivity", "ai-systems", "workflow-design"]
via: "Twitter bookmark from @hooeem"
---

A comprehensive life automation audit prompt (2-part) designed to systematically identify automation opportunities across nine life domains: primary work, side hustles, personal finance, health & fitness, daily routines, communication & relationships, home & lifestyle, learning, and content consumption.

## Key Takeaways

- **Systematic audits > random automation.** Most people don't know what to automate because they haven't conducted a proper audit; this prompt forces methodical discovery.
- Automation can reclaim 3+ hours daily, potentially 10,000+ hours over 9 years—enough time to master a new field.
- The process works in three phases: Phase 1 (conversational questionnaire across 9 life domains), Phase 2 (mapping all automation opportunities), Phase 3 (detailed implementation guides for each opportunity).
- For best results, use Claude Opus or Sonnet; the long structured prompt requires a capable LLM to handle all domains comprehensively.
- Focus on "quick wins" (high impact, low difficulty) first, then progress to complex automations; prioritize by impact-to-difficulty ratio.
- Categories of AI tools to consider: LLMs, no-code platforms (Zapier/Make), scheduling, email, finance, health, note-taking, image/video/audio, research, social media, and custom agents.
...
- [Article](https://x.com/i/article/2020515084364042240)
- [Original Tweet](https://x.com/hooeem/status/2020522623134822537)
