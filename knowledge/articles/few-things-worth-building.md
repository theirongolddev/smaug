...
The cost of integrations and simple CRUD software glue has collapsed to near zero. Anyone can wire together an app doing some API calls in minutes. So what's left worth building?
...
**Steve Yegge** recently published [Software Survival 3.0](https://steve-yegge.medium.com/software-survival-3-0-97a2a6255f7b), describing which software will survive when agents can build anything on demand. His model is simple: **software survives if it saves cognition.**
...
1. **Systems that compress hard-won insights** agents would have to rediscover at enormous token cost
2. **Systems that operate on a cheaper substrate** than inference
3. **Systems that solve hard universal problems** agents can't route around easily
4. **Systems built for how agents actually work**, not how we wish they worked
...
By Jo Kristian Bergum, CEO, Hornet.dev
