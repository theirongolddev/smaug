...
source: "https://x.com/i/article/2004648738762227713"
author: "levie"
tags: [ai-agents, knowledge-work, democratization, efficiency-paradox, automation, economics, future-of-work]
via: "Twitter bookmark from @levie"
---

As AI agents become capable of handling non-deterministic knowledge work, we'll see a Jevons Paradox—the same pattern that repeated with mainframes, minicomputers, PCs, and cloud software. Making knowledge work cheaper doesn't reduce demand; it enables entirely new use cases and industries. Every small business will have access to the resources and talent of a Fortune 500 company from a decade ago, fundamentally flattening competitive advantages. This will increase job categories and total employment despite automation of individual tasks, because the work itself becomes commodified and enables new business models and innovation cycles.

## Key Takeaways

- **The Jevons Paradox:** Efficiency improvements lead to increased demand, not reduced. Computing power has followed this pattern: mainframes (hundreds) → minicomputers (tens of thousands) → PCs (millions)
- **Non-Deterministic Work:** AI agents democratize tasks previously only accessible to large enterprises: contract review, code generation, campaign creation, research
- **The Real Leverage:** ROI improves by lowering the "I" (investment cost), not just the "R" (return). Small teams can now experiment with initiatives previously cost-prohibitive
- **Job Growth, Not Loss:** Despite automation, new opportunities emerge. Marketing jobs increased 5X+ since the 1970s despite better tools. The same will happen with AI—new types of work replace automated tasks
- **The Requirement:** AI agents still need human management, oversight, and judgment. Full autonomy is not the constraint; integration into workflows is
- **Future Demand:** Most AI tokens will be spent on work that doesn't exist today—unrealized opportunities that become viable when the cost drops
...
- [Article](https://x.com/i/article/2004648738762227713)
- [Original Tweet](https://x.com/levie/status/2004654686629163154)
