...
source: "https://x.com/i/article/2015792534526763008"
author: "nicbstme"
tags: ["llm-capabilities", "technical-debt", "ai-development", "prompt-engineering", "scaffolding", "model-improvements", "system-design"]
via: "Twitter bookmark from @nicbstme"
---

As LLMs improve exponentially, the scaffolding we build to work around their limitations becomes technical debt overnight. The article traces how system prompts have compressed from 310 lines (GPT-o3) to 104 lines (GPT-5) as models require less handholding. The core insight: sophisticated architecture that was best practice 12 months ago is now the liability. Teams need deep model awareness, strategic foresight, frontier vigilance, and ruthless iteration to survive the constant paradigm shifts.

## Key Takeaways
- Every line of scaffolding is a confession that the model wasn't good enough—vector databases, LLM frameworks, custom caching, prompt engineering teams become obsolete as capabilities move into the model
- Four LLM constants drive obsolescence: expanding context windows (100M+ tokens coming), generation speed (300+ tokens/sec now vs 30-40 before), exponential intelligence gains, and cost approaching zero
- Best AI teams celebrate deleting code and distinguish between infrastructure solving today's problems vs. infrastructure that survives the next model release
- Simple is better: Claude Code succeeds with basic filesystem + bash commands instead of complex frameworks, indicating the trend toward minimal scaffolding
- Missing a single capability announcement can render months of work obsolete—frontier vigilance is survival skill for AI development teams

## Full Content

LLMs Eat Scaffolding for Breakfast

It's Monday morning, 6:30 AM in San Francisco. I already know what's gonna happen this week. We're gonna delete our code. A lot of it. Because models are eating our code.

I will show up to our Mission office and delete thousands of lines of code. Again.
...
> GPT-o3 prompt: 310 linesGPT-5 prompt: 104 lines
...
Having an edge in building AI applications require deep technical understanding, insatiable curiosity, and low ego.

But because everything changes, it’s good to focus on what won’t change
...
Dario Amodei the founder of Anthropic expects[ 100M+ context windows](https://connect.cfauk.org/discussion/latest-interview-with-dario-amodei-ceo-of-anthropic-by-john-collison-co-founder-and-president-of-stripe?utm_source=chatgpt.com) while Sam Altman hinted at [billions of context tokens](https://techcrunch.com/2025/05/15/sam-altmans-goal-for-chatgpt-to-remember-your-whole-life-is-both-exciting-and-disturbing/?utm_source=chatgpt.com). It means the LLMs can see more context so you need less scaffolding like retrieval augmented generation.
...
- Vector databases: Companies paying thousands/month for when they could now just put docs in the prompt or use agentic-search instead of RAG ([my article on the topic](https://www.nicolasbustamante.com/p/the-rag-obituary-killed-by-agents))
...
- Model fine-tuning: Teams spending months fine-tuning models only for the next generation of out of the box models to outperform their fine-tune (cf [my 2024 article on that](https://www.nicolasbustamante.com/p/burning-billions-the-gamble-behind))
...
- [Article](https://x.com/i/article/2015792534526763008)
- [Original Tweet](https://x.com/nicbstme/status/2015795605524901957)
